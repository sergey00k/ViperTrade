    ...
    <div style={{
      ...
      <div className="fire" style={{
        ...
        {[...Array(parts)].map((_, index) => (
          ...
          <div key={index} className="particle2" style={{
            animation: `rise2 ${dur} ease-in infinite`,
            backgroundImage: `radial-gradient(${fireColor} 20%, ${fireColorT} 70%)`,
            borderRadius: '50%',
            mixBlendMode: 'screen',
            opacity: 0,
          ...
          <div key={index} className="particle3" style={{
            animation: `rise3 ${dur} ease-in infinite`,
            backgroundImage: `radial-gradient(${fireColor} 20%, ${fireColorT} 70%)`,
            borderRadius: '50%',
            mixBlendMode: 'screen',
            opacity: 0,
      ...
      <style>{`
        @keyframes rise {
          ...
          to {
            opacity: 0;
            transform: translateY(-4.2em) translateX(-2.6em); 
          }
        }
        @keyframes rise2 {
          from {
          ...
          to {
            opacity: 0;
            transform: translateY(-4.2em) translateX(3em); 
          }
        }
        @keyframes rise3 {
          from {
